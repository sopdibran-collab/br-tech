...
export const maintenancePage: ServicePageContent = {
  ...
  description: `Maintenance et entretien de VMC dans les ${site.serviceZone.display}, depuis Renens. Contrats, filtres, débits, nettoyage de conduits — offre distincte de l’installation.`,
  h1: "Maintenance et entretien de VMC",
  lead: `La performance d’une VMC (débits, filtres, hygiène des réseaux) se tient par un suivi. BR Tech Sàrl propose l’entretien et le contrat comme offre distincte de l’installation, depuis Renens, dans les ${site.serviceZone.display}.`,
  ...
  sections: [
    {
      ...
      answer:
        "La performance (débits, filtres, hygiène des réseaux) se maintient par un suivi ; BR Tech propose l’entretien comme offre séparée de l’installation.",
    ...
    },
    {
      ...
      body: "Selon le contrat : contrôle visuel, remplacement ou nettoyage des filtres, relevé de débits lorsque prévu, observations écrites. Le nettoyage de conduits, quand il est nécessaire, se discute dans le contrat ou en complément via le contact. Hors périmètre : chauffage, climatisation, plomberie.",
    },
    {
      ...
      body: "Pour un parc ou un immeuble, les passages et les observations restent traçables. Pour un logement, le compte-rendu reste lisible sans jargon. Limite : l’entretien ne remplace pas un diagnostic de panne complète — le dépannage a sa propre page.",
    },
    {
      ...
      body: "Nous citons ces normes comme cadre métier pour lire débits, filtres et hygiène de réseau — pas comme une certification de l’entreprise hors contrat. Les exigences énergétiques cantonales concernent le bâtiment ; elles ne se substituent pas au contrat d’entretien.",
    },
  ],
  faq: [
    {
    ...
    },
    {
      ...
      a: "La performance (débits, filtres, hygiène des réseaux) se maintient par un suivi ; BR Tech propose l’entretien comme offre séparée de l’installation.",
    },
    {
      q: "Le nettoyage des conduits fait-il partie de la ventilation ?",
      a: "L’hygiène des réseaux aérauliques conditionne la qualité de l’air ; ce n’est pas un nettoyage de locaux. Quand un nettoyage de conduits est nécessaire, il se discute dans le contrat ou en complément.",
    },
  ],
  related: [
