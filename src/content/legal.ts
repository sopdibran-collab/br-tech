...
export const mentions = {
  ...
  paragraphs: [
    `${site.legalName}, ${site.address.street}, ${site.address.postalCode} ${site.address.city} ${site.address.region}, ${site.address.countryName}.`,
...
export const privacy = {
  ...
  paragraphs: [
    `Les données du formulaire de contact (nom, société, téléphone, e-mail, localisation, message) sont utilisées uniquement pour traiter votre demande. Responsable : ${site.legalName}, ${site.address.street}, ${site.address.postalCode} ${site.address.city}.`,
