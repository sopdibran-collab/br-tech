...
export const servicesHub = {
  ...
  lead: `BR Tech Sàrl conçoit, pose et dépanne les réseaux de ventilation depuis Renens, dans les ${site.serviceZone.display}. Trois portes d’entrée : installation neuve, VMC double flux, dépannage. L’entretien préventif fait l’objet d’une offre dédiée. Offre limitée à la ventilation — pas de chauffage, ni de climatisation, ni de plomberie.`,
  live: [
    {
      title: "Installation",
